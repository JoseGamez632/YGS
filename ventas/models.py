...
class Cliente(models.Model): #Falta cliente_id autoinclementable
    ...
    clie_apellido = models.CharField(max_length=45, verbose_name="Apellido proveedor")
    clie_telefono = models.CharField(max_length=45, verbose_name="Telefono Cliente")
    ...
    clie_num_documento = models.CharField(max_length=16, verbose_name="Numero documento cliente")
...
class Venta(models.Model):
    ...
    vent_cliente = models.CharField(max_length=45, verbose_name="Cliente")
    vent_precio_subtotal = models.IntegerField(verbose_name="SubTotal venta")
    vent_iva = models.IntegerField(verbose_name="Iva de la venta")
    vent_precio_total = models.IntegerField(verbose_name="Precio total de la venta")
    class Estado(models.TextChoices):
        ACTIVO ='1', _('Activo')
        INACTIVO ='0', _('Inactivo')
    vent_estado = models.CharField(max_length=1, choices=Estado.choices, default=Estado.ACTIVO, verbose_name="Estado")
    Cliente_clie_id = models.ForeignKey(Cliente, verbose_name="Id cliente")
...
class Detalle_Venta(models.Model): #Falta venta_has_clientecol y venta_vent_id "autoincrementable"
    det_vent_id = models.AutoField(primary_key=True)
    det_vent_precio_unitario = models.IntegerField(verbose_name="Precio unitario del producto")
    det_vent_cantidad = models.IntegerField(verbose_name="Cantidad vendida")
    det_vent_precio_total = models.IntegerField(verbose_name="Precio total del producto")
    Servicios_serv_id = models.ForeignKey(Servicio, null=True, verbose_name="Id Servicio")
    Producto_producto_id = models.ForeignKey(Producto, null=True, verbose_name="Id Producto")
    Venta_vent_id = models.ForeignKey(Venta,  verbose_name="Id Venta")