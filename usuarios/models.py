...
class Servicio(models.Model):
    usu_id = models.ForeignKey(Usuario, verbose_name="Usuario", on_delete=models.PROTECT, related_name="Usuario1")
    #venta_vent_id = models.ForeignKey(Venta, on_delete=models.PROTECT, verbose_name="Número de venta", related_name="Venta" )
...
class Producto(models.Model):
    usu_id = models.ForeignKey(Usuario, verbose_name="Usuario", on_delete=models.PROTECT, related_name="Usuario2")
...
class Insumo(models.Model):
    usu_id = models.ForeignKey(Usuario, verbose_name="Usuario", on_delete=models.PROTECT, related_name="Usuario3")
